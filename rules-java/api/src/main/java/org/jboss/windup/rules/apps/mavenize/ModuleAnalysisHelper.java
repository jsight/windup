...
public class ModuleAnalysisHelper
{
    ...
    String deriveGroupId(ProjectModel projectModel)
    {
        ...
        {
            String groupId = (String) context.getOptionMap().get(MavenizeGroupIdOption.NAME);
            if (groupId != null)
            {
        ...
        {
            List<String> scanPackages = (List<String>) context.getOptionMap().get(ScanPackagesOption.NAME);
        ...
        //String fromPackages = new ModuleAnalysisHelper(context).deriveGroupIdFromPackages(projectModel);
