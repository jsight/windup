 ...
 * @author Ondrej Zizka
 */
public class MavenizeOperation extends AbstractIterationOperation<JavaClassFileModel>
{
    private static final Logger LOG = Logging.get(MavenizeOperation.class);
    ...
    {
        return MavenizeOperation.class.getSimpleName();
    }
}
